...
%__install -D -m0644  "%{SOURCE4}" %{buildroot}%{_prefix}/jetty-solr/etc/jetty-requestlog.xml
%__install -D -m0644  "%{SOURCE5}" %{buildroot}%{_prefix}/jetty-solr/etc/jetty.xml
